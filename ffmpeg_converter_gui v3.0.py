...
class RemuxDialog(QDialog):
    ...
    def __init__(self, parent):
        ...
        # Kompakter als vorher: 880x540 statt 900x760
    ...
    def _build_ui(self):
        ...
        # 2. Workflow-Diagramm (immer sichtbar - Anker fuer den User)
        ...
        layout.addWidget(self.diagram_container)
        ...
        layout.addStretch()  # Wenn der Dialog vergroessert wird, gehoert der Platz hier hin
