...
class RemuxDialog(QDialog):
    ...
    def _populate_from_parent(self):
        ...
        # Output-Pfad vorschlagen — blockSignals verhindert textChanged-Kaskade
    ...
    def _audio_only_extension(self) -> str:
        ...
        return {0: ".mka", 1: ".flac", 2: ".mp3", 3: ".m4a"}.get(idx, ".mka")
    ...
    def _build_remux_command(self, input_path: str, output_path: str,
        ...
        if not self.include_video_checkbox.isChecked():
            audio_codec_map = {0: None, 1: "flac", 2: "libmp3lame", 3: "aac"}
            audio_codec = audio_codec_map.get(self.audio_format_combo.currentIndex())
            if audio_codec:
